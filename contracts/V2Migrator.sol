...
import '@julswap/v2-core/contracts/libraries/LowGasSafeMath.sol';
import '@julswap/v1-core/contracts/bscswap/interfaces/IBSCswapPair.sol';
...
contract V2Migrator is IV2Migrator, PeripheryImmutableState, PoolInitializer, Multicall, SelfPermit {
    ...
    function migrate(MigrateParams calldata params) external override {
        ...
        IBSCswapPair(params.pair).transferFrom(msg.sender, params.pair, params.liquidityToMigrate);
        (uint256 amount0V2, uint256 amount1V2) = IBSCswapPair(params.pair).burn(address(this));
